...
% Source grammar: hella/references/ebnf-0.1.txt (Draft 0.3).
...
(\code{vec}), \code{K:V} maps, and owning heap pointers (\code{own T}
...
\commentary{%
  Change log carried over from the source EBNF (Draft 0.3, Phase 5 fixes
  plus own-heap phase 1):
...
\commentary{%
  The EBNF keyword list contains exactly 57 entries:
